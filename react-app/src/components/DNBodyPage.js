...
function DNBodyPage(){
  ...
  useEffect(() => {
    ...
    var arr_total = ["", "", "", "", ""];
    if(BEData != ""){
        arr_total = BEData?.details3;
    }
   var arr_total2 = ["", "", "", "", ""];
    if(BEData2 != ""){
     arr_total2 = BEData2?.details4;
   }
    function nimgez(){
   ...
   useEffect(() => {
    ...
    const [there, there_func] = useState("Highlight Review");
    function there2(){
        if(splitter()[5].length < 10){
            there_func("");
        }
        if(splitter()[6].length < 10){
            there_func("");
        }
    }
    function splitter2(){
        if(splitter()[5].includes('"')){
            return splitter()[5];
        }
        else{
            return "";
    ...
    return(
        ...
        <div class = "acc_div">
            ...
            <p class = "p_class2">Highlight Review/Additional Info: </p>
            <p class = "p_class">{splitter()[5]}</p>
            <p class = "p_class">{splitter()[6]}</p>
            </div>
        </div>
        <div class = "pic_div">
            <div class = "pic_div2">
